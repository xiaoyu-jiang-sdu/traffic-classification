...
from model import CNN2DBaseLine
...
model = CNN2DBaseLine(num_classes=20).to(device)

optimizer = torch.optim.Adam(model.parameters(), lr=lr)
criterion = nn.CrossEntropyLoss()

train_dataset = FlowDataset('../../data/USTC-TFC2016/raw/train.csv', 784)
val_dataset = FlowDataset('../../data/USTC-TFC2016/raw/valid.csv', 784)
...
for epoch in range(epochs):
    ...
    for flow_tensor, label in pbar:
        ...
        flow_tensor = flow_tensor.view(-1, 1, 28, 28)
